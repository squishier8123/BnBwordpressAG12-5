...
{
    protected $shortcode_name = 'listdom_category';
    protected $taxonomy = 'category';
    
    public function get_name(): string
    {
        return 'lsd-listing-category';
    }

    public function get_title(): string
    {
        return esc_html__('Listdom Category', 'listdom-elementor');
    }
    ...
    protected function get_available_styles(): array
    {
        return [
            ...
            'carousel' => esc_html__('Carousel', 'listdom-elementor'),
        ];
    }
