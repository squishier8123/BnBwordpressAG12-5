<?php
/**
 * Plugin Name: Beards & Bucks Custom Styles
 * Plugin URI: https://beardsandbucks.com
 * Description: Custom CSS for Beards & Bucks brand colors and effects
 * Version: 1.0.0
 * Author: Beards & Bucks
 * Text Domain: beards-bucks-styles
 */

// Add custom CSS to the head of every page
...
/* ============================================================================
   ...
   ============================================================================
   Purpose: Apply hunting brand color palette strategically + add shadows & effects
   Color Palette:
   - Deep Brown (#582F0E) - Rich, masculine, primary accent
   - Rich Brown (#7F4F24) - Warm, premium feel
   - Medium Brown (#936639) - Transitional shade
   - Tan/Beige (#A68A64, #B6AD90) - Earthy, neutral
   - Cream (#C2C5AA) - Light accents, highlights
   - Sage Green (#A4AC86, #414833, #656D4A) - Nature, calm
   - Dark Green (#333D29) - Deepest accent
   ============================================================================ */
...
/* ============================================================================
   HERO & LARGE SECTIONS - Deep Brown backgrounds with light text
   ============================================================================ */
...
/* Hero sections - use deep brown as primary background */
.hero,
.hero-section,
.banner-section,
.page-banner,
...
/* ============================================================================
   CARD & CONTAINER STYLING - Add depth with shadows
   ============================================================================ */
...
.product-card::before {
  ...
  right: 0;
  bottom: 0;
  background: linear-gradient(135deg, transparent 0%, rgba(164, 172, 134, 0.05) 100%);
  opacity: 0;
...
.card:hover::before,
.listing-item-container:hover::before,
.product-card:hover::before {
  opacity: 1;
}

/* ============================================================================
   BUTTON STYLING - Add shadows and interactive effects
   ============================================================================ */
...
button:not(.orange):not([class*="secondary"]),
a.button:not(.orange),
input[type="submit"]:not(.orange),
.btn:not(.orange),
.wp-block-button__link,
.et_pb_button {
...
/* Button hover - lift and glow effect */
button:not(.orange):not([class*="secondary"]):hover,
a.button:not(.orange):hover,
input[type="submit"]:not(.orange):hover,
...
/* Button active state */
button:not(.orange):active,
a.button:not(.orange):active,
.btn:not(.orange):active,
...
.button-secondary {
  ...
  border: 2px solid var(--bb-sage-light) !important;
...
/* ============================================================================
   HEADER & NAVIGATION - Sophisticated styling with accents
   ============================================================================ */
...
#navigation a.active {
  color: var(--bb-sage-light) !important;
  border-bottom: 2px solid var(--bb-sage-light) !important;
}

/* ============================================================================
   FORM INPUTS - Clean with subtle focus effects
   ============================================================================ */
...
/* ============================================================================
   ACCENT & HIGHLIGHT ELEMENTS - Use sage greens strategically
   ============================================================================ */
...
.tag-featured,
.featured-badge {
  background: linear-gradient(135deg, var(--bb-sage-light) 0%, var(--bb-sage-medium) 100%) !important;
  color: var(--bb-white) !important;
  box-shadow: var(--bb-glow) !important;
}

/* ============================================================================
   PRICE DISPLAY - Premium styling with shadows
   ============================================================================ */
...
/* ============================================================================
   TEXT & HEADINGS - Brand color hierarchy
   ============================================================================ */
...
h5, h6 {
  color: var(--bb-sage-medium) !important;
}
...
/* ============================================================================
   FOOTER - Sophisticated dark background with warm accents
   ============================================================================ */
...
/* ============================================================================
   MOUSE EFFECTS - Hover, focus, and interactive states
   ============================================================================ */
...
/* ============================================================================
   SPECIAL EFFECTS - Advanced mouse interactions
   ============================================================================ */

/* Card glow effect on hover */
.has-glow-effect:hover {
  box-shadow: var(--bb-shadow-xl), 0 0 30px rgba(164, 172, 134, 0.3) !important;
}
...
/* ============================================================================
   UTILITY CLASSES - Quick color/effect application
   ============================================================================ */
...
/* ============================================================================
   END OF BRAND COLORS & EFFECTS CSS
   ============================================================================ */
    </style>
    <?php
}, 20 );
