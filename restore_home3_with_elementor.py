#!/usr/bin/env python3
"""
Restore Home 3 page (ID: 4370) from revision 4672 using REST API
"""
import requests
import json
import base64
...
print("=== HOME 3 PAGE RESTORATION ===\n")

# Step 1: Get revision 4672 data
print("Step 1: Fetching revision 4672 data...")
try:
...
# Step 2: Update page with revision content
print("Step 2: Restoring page with revision content...")
try:
    update_data = {
        "content": content,
        "title": title
...
print("Step 3: Verifying restoration...")
try:
    ...
    if verify_response.status_code == 200:
        ...
        if verify_content_len >= len(content):
            print(f"✅ RESTORATION SUCCESSFUL!")
            print(f"\n   Original revision content: {len(content)} chars")
            print(f"   Current page content: {verify_content_len} chars")
...
print("="*60)
print("Home 3 page restoration complete!")
print("="*60)
